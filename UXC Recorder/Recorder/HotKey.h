...
{
	sHotKeyOpts()
		: m_RecordStart(VK_UNDEFINED)  //UXC:  Remove VK_F8
		, m_RecordEnd(VK_UNDEFINED)   //UXC:  Remove VK_F9
		, m_RecordCancel(VK_UNDEFINED)    //UXC:  Remove VK_F10
		, m_Next(VK_UNDEFINED, MOD_CONTROL)   ///UXC:  Remove VK_F11
